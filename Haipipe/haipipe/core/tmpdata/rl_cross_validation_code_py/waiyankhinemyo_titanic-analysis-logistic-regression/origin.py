...
import numpy as np
#np.save("haipipe/core/tmpdata/prenotebook_res/waiyankhinemyo_titanic-analysis-logistic-regression.npy", { "accuracy_score": score })
np.save("haipipe/core/tmpdata/rl_cross_val_res/waiyankhinemyo_titanic-analysis-logistic-regression/origin.npy", { "accuracy_score": cross_score })
