...
import numpy as np
#np.save("haipipe/core/tmpdata/merge_max_result_rl/waiyankhinemyo_titanic-analysis-logistic-regression/1392.npy", { "accuracy_score": score })
np.save("haipipe/core/tmpdata/rl_cross_val_res/waiyankhinemyo_titanic-analysis-logistic-regression/1392.npy", { "accuracy_score": cross_score })
