...
import numpy as np
#np.save("haipipe/core/tmpdata/prenotebook_res/monukhan_predict-person-purchased-the-product-or-not.npy", { "accuracy_score": score })
np.save("haipipe/core/tmpdata/rl_cross_val_res/monukhan_predict-person-purchased-the-product-or-not/origin.npy", { "accuracy_score": cross_score })
