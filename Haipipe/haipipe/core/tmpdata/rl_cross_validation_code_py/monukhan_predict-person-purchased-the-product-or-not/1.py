...
import numpy as np
#np.save("haipipe/core/tmpdata/merge_max_result_rl/monukhan_predict-person-purchased-the-product-or-not/1.npy", { "accuracy_score": score })
np.save("haipipe/core/tmpdata/rl_cross_val_res/monukhan_predict-person-purchased-the-product-or-not/1.npy", { "accuracy_score": cross_score })
