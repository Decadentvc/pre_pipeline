...
import numpy as np
#np.save("haipipe/core/tmpdata/merge_max_result_rl/reacherai_my-moneyball/58.npy", { "accuracy_score": score })
np.save("haipipe/core/tmpdata/rl_cross_val_res/reacherai_my-moneyball/58.npy", { "accuracy_score": cross_score })
