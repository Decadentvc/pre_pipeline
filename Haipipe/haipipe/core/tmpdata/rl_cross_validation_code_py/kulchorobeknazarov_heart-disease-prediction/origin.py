...
import numpy as np
#np.save("haipipe/core/tmpdata/prenotebook_res/kulchorobeknazarov_heart-disease-prediction.npy", { "accuracy_score": score })
np.save("haipipe/core/tmpdata/rl_cross_val_res/kulchorobeknazarov_heart-disease-prediction/origin.npy", { "accuracy_score": cross_score })
