...
import numpy as np
#np.save("haipipe/core/tmpdata/merge_max_result_rl/kulchorobeknazarov_heart-disease-prediction/228.npy", { "accuracy_score": score })
np.save("haipipe/core/tmpdata/rl_cross_val_res/kulchorobeknazarov_heart-disease-prediction/228.npy", { "accuracy_score": cross_score })
