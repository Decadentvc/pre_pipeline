...
import numpy as np
#np.save("haipipe/core/tmpdata/merge_max_result_rl/samuelterry_lab-01/21.npy", { "accuracy_score": score })
np.save("haipipe/core/tmpdata/rl_cross_val_res/samuelterry_lab-01/21.npy", { "accuracy_score": cross_score })
