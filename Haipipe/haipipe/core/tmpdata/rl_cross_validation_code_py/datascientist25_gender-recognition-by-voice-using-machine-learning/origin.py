...
import numpy as np
#np.save("haipipe/core/tmpdata/prenotebook_res/datascientist25_gender-recognition-by-voice-using-machine-learning.npy", { "accuracy_score": score })
np.save("haipipe/core/tmpdata/rl_cross_val_res/datascientist25_gender-recognition-by-voice-using-machine-learning/origin.npy", { "accuracy_score": cross_score })
