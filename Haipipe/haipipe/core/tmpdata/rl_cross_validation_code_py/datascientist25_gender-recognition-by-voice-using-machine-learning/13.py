...
import numpy as np
#np.save("haipipe/core/tmpdata/merge_max_result_rl/datascientist25_gender-recognition-by-voice-using-machine-learning/13.npy", { "accuracy_score": score })
np.save("haipipe/core/tmpdata/rl_cross_val_res/datascientist25_gender-recognition-by-voice-using-machine-learning/13.npy", { "accuracy_score": cross_score })
