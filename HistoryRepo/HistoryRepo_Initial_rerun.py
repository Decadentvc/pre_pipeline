...
EVALUATE_DATASET_ID = [5, 10, 11, 30]   # 例如 [3,4] 表示评估排序后的 dataset_paths 中第 3、4 个数据集（1-based）
...
def main():
    ...
    if task_allow_set is not None:
        ...
        OUTPUT_CSV = f"evaluation_results_datasets_{'_'.join(map(str, sorted_ds))}.csv"
    else:
